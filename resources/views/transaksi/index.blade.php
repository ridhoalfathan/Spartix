            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><strong>{{ $transaksi->pesanan->product->product_name ?? '-' }}</strong></td>
                        <td>{{ $transaksi->nama_pengirim }}</td>
                        <td><span class="price-tag">Rp {{ number_format($transaksi->total_transaksi, 0, ',', '.') }}</span></td>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="{{ route('transaksi.show', $transaksi->id) }}" class="btn-action btn-view" title="Lihat Detail">
                                    <i class='bx bx-show'></i>
                                </a>
                                <a href="{{ route('transaksi.edit', $transaksi->id) }}" class="btn-action btn-edit" title="Edit">
                                    <i class='bx bx-edit'></i>
                                </a>
                                <form action="{{ route('transaksi.destroy', $transaksi->id) }}" method="POST" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn-action btn-delete" title="Hapus" onclick="return confirm('Yakin ingin menghapus transaksi ini?')">
