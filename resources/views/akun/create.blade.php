...
@section('title', 'Tambah Akun - RAYA-E')
...
<div class="form-card">
    ...
    <form action="{{ route('akun.store') }}" method="POST">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="kategori" class="form-select @error('kategori') is-invalid @enderror">
                        ...
                        <option value="Tidak Lancar"    {{ old('kategori') == 'Tidak Lancar'    ? 'selected' : '' }}>Tidak Lancar</option>
                        <option value="Operasional"     {{ old('kategori') == 'Operasional'     ? 'selected' : '' }}>Operasional</option>
                        <option value="Non-Operasional" {{ old('kategori') == 'Non-Operasional' ? 'selected' : '' }}>Non-Operasional</option>
                    </select>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="hidden" name="saldo_normal" id="saldo-hidden" value="0">
                    </div>
        ...
        <div class="info-box">
            ...
            <div>Pastikan kode akun unik dan belum digunakan. Gunakan sistem penomoran yang konsisten.</div>
        </div>
