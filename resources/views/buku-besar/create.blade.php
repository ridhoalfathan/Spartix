...
@section('page-title', 'Tambah Akun Buku Besar')
...
<div class="form-card">
    <div class="form-header">
        ...
        <h2>Tambah Akun Buku Besar Baru</h2>
    </div>

    <div class="info-box">
        <strong>💡 Info:</strong> Buat akun buku besar untuk mencatat transaksi keuangan. Akun ini akan otomatis mengambil data dari Jurnal Umum.
    </div>
    ...
    <form action="{{ route('buku-besar.store') }}" method="POST">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <select id="jenis_akun" name="jenis_akun" required>
                    ...
                    <option value="Aset" {{ old('jenis_akun') == 'Aset' ? 'selected' : '' }}>Aset</option>
                    <option value="Liabilitas" {{ old('jenis_akun') == 'Liabilitas' ? 'selected' : '' }}>Liabilitas</option>
                    <option value="Ekuitas" {{ old('jenis_akun') == 'Ekuitas' ? 'selected' : '' }}>Ekuitas</option>
                    <option value="Pendapatan" {{ old('jenis_akun') == 'Pendapatan' ? 'selected' : '' }}>Pendapatan</option>
                    <option value="Beban" {{ old('jenis_akun') == 'Beban' ? 'selected' : '' }}>Beban</option>
                </select>
                @error('jenis_akun')
                    <span class="error-message">{{ $message }}</span>
                @enderror
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn btn-primary">
                <i class='bx bx-check'></i> Simpan Akun
            </button>
        </div>
    </form>
</div>
