...
<div class="form-card">
    ...
    <div class="alert-info">
        <i class='bx bx-info-circle'></i> <strong>Perhatian:</strong> Pesanan ini sudah Complete. Mengubah status ke Pending akan mengembalikan stock produk.
    </div>
    @endif
    ...
    <form action="{{ route('pesanan.update', $pesanan->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select id="product_id" name="product_id" required>
                    ...
                    @foreach($products as $product)
                        <option value="{{ $product->id }}" {{ old('product_id', $pesanan->product_id) == $product->id ? 'selected' : '' }}>
        ...
        <div class="form-row">
            <div class="form-group full-width">
                ...
                <div class="radio-group">
                    ...
                    <div class="radio-option">
                        <input 
                            ...
                            name="status" 
                            value="Complete"
                            {{ old('status', $pesanan->status) == 'Complete' ? 'checked' : '' }}
                        >
                ...
                <p style="font-size: 12px; color: #64748b; margin-top: 8px;">
                    <i class='bx bx-info-circle'></i> Mengubah status dari Pending ke Complete akan mengurangi stock produk
                </p>
            </div>
        </div>
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn btn-primary">
                <i class='bx bx-check'></i> Update Pesanan
            </button>
        </div>
    </form>
</div>
